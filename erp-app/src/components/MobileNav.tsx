            ...
            <div className="py-2">
              ...
              {user?.role === 'salesperson' && (
                <>
                  ...
                  <a
                    href="https://solution.wisetax.kr/?managerID=23023"
                    target="_blank"
                    rel="noopener noreferrer"
                    onClick={closeMenu}
                    className="flex items-center space-x-3 px-4 py-3 transition-colors text-gray-700 hover:bg-gray-50"
                  >
                    <span className="text-lg">📝</span>
              ...
              {user?.role === 'admin' && (
                <>
                  ...
                  >
                    <span className="text-sm font-medium">전체 DB 관리</span>
                  </NavLink>
                  <NavLink
                    to="/sales-db/register"
                    onClick={closeMenu}
                  ...
                  >
                    <span className="text-sm font-medium">종합소득세 계산기</span>
                  </NavLink>
                  <NavLink
